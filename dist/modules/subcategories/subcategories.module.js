...
const subcategories_resolver_1 = require("./subcategories.resolver");
...
exports.SubCategoriesModule = SubCategoriesModule = __decorate([
    (0, common_1.Module)({
        providers: [subcategories_resolver_1.SubCategoriesResolver, subcategories_service_1.SubCategoriesService, prisma_service_1.PrismaService],
    })
], SubCategoriesModule);
